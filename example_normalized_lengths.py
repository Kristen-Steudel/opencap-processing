...
session_id = os.path.normpath(f'G:\\Shared drives\\Stanford Football\\January_26\\subject{subject_num}\\OpenSimData\\OpenPose_default\\3-cameras')


# Specify trial names in a list; use None to process all trials in a session.
specific_trial_names = [f'ID{subject_num}_S3_fly_LSTM'] #'ACCEL_LSTM', 'DECEL_LSTM']
