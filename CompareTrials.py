...
# Both configs are always imported directly — this script is not subject to
# the PIPELINE_CONFIG env-var switching used by the single-trial steps.
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, SCRIPT_DIR)
import pipeline_config_CameraTest as cfg_a
import pipeline_config_OpenCap    as cfg_b
